...
object ExifSegment {
  //val ExifEndTag = Tag(0, "ExifEnd")
  //val ExifIfdTag = Tag(0x8769, "ExifIfd")
  //val OrientationTag = Tag(0x0112, "Orientation")
  //val UserComments = Tag(0x9286, "UserComments")
  //val DateTimeTag = Tag(0x0132, "DateTime")
 ...
 * 
 * @param marker segment marker, see [[de.n12n.exif.Segment]].
 * @param length segment length, see [[de.n12n.exif.Segment]].
